...
| **Planning item** | yoke-project/yoke-sdk-cpp#11 |

## yoke-sdk-cpp:the-check-runner.01 — a check whose name holds a digit is run
...
## yoke-sdk-cpp:the-check-runner.02 — a marker whose check cannot be found is reported as failing
