...
| **Planning item** | yoke-project/yoke-sdk-cpp#1 |

## yoke-sdk-cpp:verbs-and-licence.01 — every verb is defined, and none is silent
...
## yoke-sdk-cpp:verbs-and-licence.02 — nothing resolves a path outside the repository
...
## yoke-sdk-cpp:verbs-and-licence.03 — the repository builds in the container it defines itself
...
## yoke-sdk-cpp:verbs-and-licence.04 — the licence is the one this repository's role assigns
...
## yoke-sdk-cpp:verbs-and-licence.05 — `develop` fails on a runner older than the floor
...
## yoke-sdk-cpp:verbs-and-licence.06 — `fmt` fails on an unformatted tree
...
| **Not applicable in** | — |
| **Label** | blocking |
| **Precondition** | a copy of the checkout with one C++ file left unformatted |
